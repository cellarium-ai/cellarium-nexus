...
@job.dsl_component_job(base_image=BASE_IMAGE, machine_type="e2-standard-4", display_name="create_ingest_files")
...
@job.dsl_component_job(base_image=BASE_IMAGE, machine_type="e2-standard-16", display_name="ingest_data_to_bigquery")
...
@job.dsl_component_job(base_image=BASE_IMAGE, machine_type="e2-standard-4", display_name="prepare_extract")
...
@job.dsl_component_job(base_image=BASE_IMAGE, machine_type="e2-standard-32", display_name="extract")
