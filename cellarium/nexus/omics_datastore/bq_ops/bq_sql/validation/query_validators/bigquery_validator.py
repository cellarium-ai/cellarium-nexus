...
from cellarium.nexus.omics_datastore.bq_ops.bq_sql.validation import exceptions
...
class BigQuerySQLSyntaxValidator(SQLSyntaxValidator):
    ...
    @staticmethod
    def _bq_dry_run_query(query: str) -> QueryJob:
        """
    ...
    @staticmethod
    def _parse_google_bq_error_message(error: gc_exceptions.GoogleCloudError) -> str:
        """
        ...
        :param error: The GoogleCloudError exception captured during the dry-run query execution.
    ...
    def validate_syntax(cls, sql_query: str) -> None:
        """
        Validate the syntax of a rendered SQL query using BigQuery Dry Run.
