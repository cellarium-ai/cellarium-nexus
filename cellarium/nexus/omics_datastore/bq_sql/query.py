...
from nexus.omics_datastore.bq_sql.template_data import TemplateData
from nexus.omics_datastore.bq_sql.validation.query_validators import BigQuerySQLSyntaxValidator
...
def render(
    ...
    :class:`~datastore_manager.bq_sql.TemplateData` instance, and perform an optional syntax validation on the resulting
    ...
    :param template_data: A :class:`~datastore_manager.bq_sql.TemplateData` instance with data to be used in the SQL
        template rendering.
    :param sql_query_validator_class: SQL query syntax validator class. Must be a subclass
        of :class:`~datastore_manager.bq_sql.validation.query_validators.SQLSyntaxValidator` |br|
        `Default:` :class:`~datastore_manager.bq_sql.validation.query_validators.BigQuerySQLSyntaxValidator`
    :param sql_query_validator_on: A flag describing whether to use a bq_sql query validation. Recommended to use only
        in dev mode |br|
        `Default:` ``False``
